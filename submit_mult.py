...
os.system("python3 HTCondor_submit_multiplicity.py -i inputdataset/PF_Run23_UPC_nonemptyfiles -o "+str(outputfolder)+"/"+str(inPut)+"/PbPb_UPC_job_ -f tomorrow -c 2 -n 29 -s PbPb_UPC_job_ -u "+str(systematics)+" -w "+str(cmsswrepo)+" -p "+str(pwdrepo))
